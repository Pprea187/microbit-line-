...
> Άνοιγμα αυτής της σελίδας στο [https://pprea187.github.io/microbit-line-/](https://pprea187.github.io/microbit-line-/)
...
* αναζήτηση για **https://github.com/pprea187/microbit-line-** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/pprea187/microbit-line-/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/pprea187/microbit-line-** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/pprea187/microbit-line-/raw/master/.github/makecode/blocks.png)
